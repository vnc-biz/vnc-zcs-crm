...
function() {	
	...
	var xFormObject = {
		...
		{ref:ZaCRMadmin.A_stateName, type:_TEXTFIELD_, label:com_zimbra_crm_admin.HDR_name+":", labelLocation:_LEFT_, width:250},
		{ref:ZaCRMadmin.A_stateCode, type:_TEXTFIELD_, label:com_zimbra_crm_admin.HDR_code+":", labelLocation:_LEFT_, width:250},
		...
		{ref:ZaCRMadmin.A_stateCountryStatus,type:_ZA_CHECKBOX_, label:com_zimbra_crm_admin.HDR_status, trueValue:true, falseValue:false, visibilityChecks:[], enableDisableChecks:[]}
