/*function com_zimbra_crm_admin_HandlerObject() {};

com_zimbra_crm_admin_HandlerObject.prototype = new ZmZimletBase();
com_zimbra_crm_admin_HandlerObject.prototype.constructor = com_zimbra_crm_admin_HandlerObject;

com_zimbra_crm_admin_HandlerObject.prototype.init =function(){
	com_zimbra_crm_admin_HandlerObject.obj = this;
};
*/
...
ZaCRM_Panel.backupOvTreeModifier = function (tree) {
	if(ZaSettings.ENABLED_UI_COMPONENTS[ZaSettings.BACKUP_VIEW] || ZaSettings.ENABLED_UI_COMPONENTS[ZaSettings.CARTE_BLANCHE_UI]) {
		this._crmTi = new DwtTreeItem({parent:this._toolsTi,className:"AdminTreeItem"});
		this._crmTi.setText(com_zimbra_crm_admin.CRM_tab_title);
...
ZaApp.prototype.getCRMadminViewController =
function() {
