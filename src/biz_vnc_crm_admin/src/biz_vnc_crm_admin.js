/*function biz_vnc_crm_admin_HandlerObject() {};

biz_vnc_crm_admin_HandlerObject.prototype = new ZmZimletBase();
biz_vnc_crm_admin_HandlerObject.prototype.constructor = biz_vnc_crm_admin_HandlerObject;

biz_vnc_crm_admin_HandlerObject.prototype.init =function(){
	biz_vnc_crm_admin_HandlerObject.obj = this;
};
*/
