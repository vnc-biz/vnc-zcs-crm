...
var ZaCRMStageModel = function(parent) {
    ZaTabView.call(this, {
        parent: parent,
...
ZaCRMStageModel.stageSelectionListener = function (ev) {
...
ZaCRMStageModel.updateStage = function () {
    ...
    if (this.parent.editStageDlg) {
        ...
        var j = JSON.stringify({
            ...
            stageName: obj[ZaCRMadmin.A_stageName],
            stageSequence: obj[ZaCRMadmin.A_stageSequence],
            stageType: obj[ZaCRMadmin.A_stageType],
            stageState: obj[ZaCRMadmin.A_stageState],
            stageProbability: obj[ZaCRMadmin.A_stageProbability],
            stageDescription: obj[ZaCRMadmin.A_stageDescription],
            stageAuto: obj[ZaCRMadmin.A_stageAuto],
