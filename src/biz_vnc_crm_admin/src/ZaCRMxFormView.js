        ...
        items: [{
            ...
            items: [{
                ...
                //for main box of header list
                {
                    ...
                    multiselect: true,
                    cssClass: "DLSource",
                    headerList: biz_vnc_crm_admin.headerList_comp,
            ...
            items: [{
                ...
                //for main box of header list
                {
                    ...
                    multiselect: true,
                    cssClass: "DLSource",
                    headerList: biz_vnc_crm_admin.headerList_cont,
            ...
            items: [{
                ...
                //for main box of header list
                {
                    ...
                    multiselect: true,
                    cssClass: "DLSource",
                    headerList: biz_vnc_crm_admin.headerList_channel,
            ...
            items: [{
                ...
                //for main box of header list
                {
                    ...
                    multiselect: true,
                    cssClass: "DLSource",
                    headerList: biz_vnc_crm_admin.headerList_priority,
            ...
            items: [{
                ...
                //for main box of header list
                {
                    ...
                    multiselect: true,
                    cssClass: "DLSource",
                    headerList: biz_vnc_crm_admin.headerList_category,
            ...
            items: [{
                ...
                items: [{
                    ...
                    multiselect: true,
                    cssClass: "DLSource",
                    headerList: biz_vnc_crm_admin.headerList_stage,
            ...
            items: [{
                ...
                //for main box of header list
                {
                    ...
                    multiselect: true,
                    cssClass: "DLSource",
                    headerList: biz_vnc_crm_admin.headerList_leadClass,
