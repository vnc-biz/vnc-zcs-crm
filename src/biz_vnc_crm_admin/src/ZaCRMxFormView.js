...
ZaCRMxFormView.myXFormModifier = function(xFormObject) {	
	...
	xFormObject.items=[{type:_TAB_BAR_,  ref:ZaModel.currentTab,id:"crm_admin_xform_tabbar", containerCssStyle: "padding-top:0px",cssClass:"ZaTabBar",
				choices:[
				{value:1,label:biz_vnc_crm_admin.TBB_company},
				{value:2,label:biz_vnc_crm_admin.TBB_country},
				{value:3,label:biz_vnc_crm_admin.TBB_country_state},
				{value:4,label:biz_vnc_crm_admin.TBB_channel},
				{value:5,label:biz_vnc_crm_admin.TBB_priority},
				{value:6,label:biz_vnc_crm_admin.TBB_category},
				{value:7,label:biz_vnc_crm_admin.TBB_section},
				{value:8,label:biz_vnc_crm_admin.TBB_stage}
				]
			   },
			   {type:_SWITCH_,id:"tab1",
				items:[{ type:_ZATABCASE_,id:"crm_company",ref:ZaModel.currentTab,relevant:"instance[ZaModel.currentTab] == 1",numCols:1,colSizes:["800px"],caseKey:newTab++,
					items:[{type:_ZA_TOP_GROUPER_, id:"crm_company_group",width:"100%",
							numCols:1,colSizes:["auto"],label:"Company List",
							...
							{ref:ZaCRMadmin.A_company, type:_DWT_LIST_, height:"300px",width:"1500", 
							forceUpdate: true, preserveSelection:false,multiselect:true,
							cssClass:"DLSource", headerList:headerList_cont, widgetClass:ZaCRMadminCompanyListView,
							onSelection:ZaCRMCompanyModel.companySelectionListener,onChange:ZaCRMxFormView.currentFieldChanged,
							...
							items: [{type:_DWT_BUTTON_, label:biz_vnc_crm_admin.BTN_Delete,width:"100px",
							...
							relevantBehavior:_DISABLE_
								...
								{type:_CELLSPACER_},
								{type:_DWT_BUTTON_, label:biz_vnc_crm_admin.BTN_Edit,width:"100px",
								...
								{type:_CELLSPACER_},
								{type:_DWT_BUTTON_, label:biz_vnc_crm_admin.BTN_Add,width:"100px",
								onActivate:"ZaCRMCompanyModel.addButtonListener.call(this);"
								}]
							}]
						}]
				},
				{ type:_ZATABCASE_,id:"crm_country",ref:ZaModel.currentTab,relevant:"instance[ZaModel.currentTab] == 2",numCols:1,colSizes:["800px"],caseKey:newTab++,
				...
				{ type:_ZATABCASE_,id:"crm_state",ref:ZaModel.currentTab,relevant:"instance[ZaModel.currentTab] == 3",numCols:1,colSizes:["800px"],caseKey:newTab++,
					...
					{ type:_ZATABCASE_,id:"crm_channel",ref:ZaModel.currentTab,relevant:"instance[ZaModel.currentTab] == 4",numCols:1,colSizes:["800px"],caseKey:newTab++,
				...
				{ type:_ZATABCASE_,id:"crm_priority",ref:ZaModel.currentTab,relevant:"instance[ZaModel.currentTab] == 5",numCols:1,colSizes:["800px"],caseKey:newTab++,
					...
					{ type:_ZATABCASE_,id:"crm_category",ref:ZaModel.currentTab,relevant:"instance[ZaModel.currentTab] == 6",numCols:1,colSizes:["800px"],caseKey:newTab++,
					...
					{ type:_ZATABCASE_,id:"crm_section",ref:ZaModel.currentTab,relevant:"instance[ZaModel.currentTab] == 7",numCols:1,colSizes:["800px"],caseKey:newTab++,
						items:[{type:_ZA_TOP_GROUPER_, id:"crm_section_group",width:"100%", 
								...
								items: [
								//for main box of header list
								{ref:ZaCRMadmin.A_section, type:_DWT_LIST_, height:"300px",width:"1550", 
								forceUpdate: true, preserveSelection:false,multiselect:true,
						...
						{ type:_ZATABCASE_,id:"crm_stage",ref:ZaModel.currentTab,relevant:"instance[ZaModel.currentTab] == 8",numCols:1,colSizes:["800px"],caseKey:newTab++,
							...
							items: [
							//for main box of header list
							{ref:ZaCRMadmin.A_stage, type:_DWT_LIST_, height:"300px",width:"1450", 
							forceUpdate: true, preserveSelection:false,multiselect:true,
