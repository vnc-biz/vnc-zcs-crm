...
ZaCRMSectionModel.updateSection=function()
{
	if(this.parent.editSectionDlg) 
	{
		...
		var j = JSON.stringify({action:"UPDATE",object:"section",sectionId:obj[ZaCRMadmin.A_sectionId],sectionName:obj[ZaCRMadmin.A_sectionName],sectionCode:obj[ZaCRMadmin.A_sectionCode],sectionManagerId:obj[ZaCRMadmin.A_sectionManagerId],sectionLeaderId:obj[ZaCRMadmin.A_sectionLeaderId],sectionWatcherId:obj[ZaCRMadmin.A_sectionWatcherId],sectionSalesTeamIds:temp,status:obj[ZaCRMadmin.A_sectionStatus],writeBy:obj[ZaCRMadmin.A_sectionWriteby]});
		var json = "jsonobj=" + j;
		var reqHeader = {"Content-Type":"application/x-www-form-urlencoded"};
		var reqJson = AjxStringUtil.urlEncode(json);
		var response = AjxRpc.invoke(reqJson,biz_vnc_crm_admin.jspUrl, reqHeader, null, false);
...
//		AjxUtil.isEmpty(test) ? [] : test;
	...
	//	console.log("-------test--->"+test);	
		...
		if(flag == 0)
		{
			...
			var j = JSON.stringify({action:"ADD",object:"section",sectionId:obj[ZaCRMadmin.A_sectionId],sectionName:obj[ZaCRMadmin.A_sectionName],sectionCode:obj[ZaCRMadmin.A_sectionCode],sectionManagerId:obj[ZaCRMadmin.A_sectionManagerId],sectionLeaderId:obj[ZaCRMadmin.A_sectionLeaderId],sectionWatcherId:obj[ZaCRMadmin.A_sectionWatcherId],sectionSalesTeamIds:test,status:obj[ZaCRMadmin.A_sectionStatus],createBy:obj[ZaCRMadmin.A_sectionCreatedby],writeBy:obj[ZaCRMadmin.A_sectionWriteby]});
			var json = "jsonobj=" + j;
			var reqHeader = {"Content-Type":"application/x-www-form-urlencoded"};
			var reqJson = AjxStringUtil.urlEncode(json);
			var response = AjxRpc.invoke(reqJson,biz_vnc_crm_admin.jspUrl, reqHeader, null, false);
...
//	var commonExtArr = ["aaa", "bbbb", "ddd", "eeeee", "ffff"]; 
...
//		obj[ZaCRMadmin.A_sectionManagerId]= "";
