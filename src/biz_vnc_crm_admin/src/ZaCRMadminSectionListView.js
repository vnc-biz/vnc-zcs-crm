var headerList_section = new Array();
	...
	//headerList_section[3] = new ZaListHeaderItem(ZaCRMadmin.A_sectionUserId, biz_vnc_crm_admin.HDR_sectionUId, null,"150px", true,ZaCRMadmin.A_sectionUserId,true, true);
