...
function() {	
	...
	var xFormObject = {
		...
		{ref:ZaCRMadmin.A_sectionName, type:_TEXTFIELD_, label:biz_vnc_crm_admin.HDR_name+":", labelLocation:_LEFT_, width:250},
		{ref:ZaCRMadmin.A_sectionCode, type:_TEXTFIELD_, label:biz_vnc_crm_admin.HDR_code+":", labelLocation:_LEFT_, width:250},
		{type:_SPACER_, height:"5"},
		{ref:ZaCRMadmin.A_sectionManagerId, type:_OSELECT1_, msgName:"sections",label:biz_vnc_crm_admin.HDR_sectionManagerId+":", labelLocation:_LEFT_, choices:ZaEditSectionXFormDialog.userChoices,width:"250px", onChange:ZaTabView.onFormFieldChanged},
		{type:_SPACER_, height:"5"},
		{ref:ZaCRMadmin.A_sectionLeaderId, type:_OSELECT1_, msgName:"sections",label:biz_vnc_crm_admin.HDR_sectionLeaderId+":", labelLocation:_LEFT_, choices:ZaEditSectionXFormDialog.userChoices,width:"250px", onChange:ZaTabView.onFormFieldChanged},
		{type:_SPACER_, height:"5"},
		{ref:ZaCRMadmin.A_sectionWatcherId, type:_OSELECT1_, msgName:"sections",label:biz_vnc_crm_admin.HDR_sectionWatcherId+":", labelLocation:_LEFT_, choices:ZaEditSectionXFormDialog.userChoices,width:"250px", onChange:ZaTabView.onFormFieldChanged},
		{type:_SPACER_, height:"5"},
	//	{ref:ZaCRMadmin.A_sectionSalesTeamIds, type:_OSELECT_, msgName:"sections ",label:biz_vnc_crm_admin.HDR_sectionSalesTeamIds+":", labelLocation:_LEFT_, choices:ZaEditSectionXFormDialog.userChoices,width:"250px", height:"200px", onChange:ZaTabView.onFormFieldChanged},
		{type:_SPACER_, height:"5"},
		{ref:ZaCRMadmin.A_sectionStatus,type:_ZA_CHECKBOX_, label:biz_vnc_crm_admin.HDR_status, trueValue:true, falseValue:false, visibilityChecks:[], enableDisableChecks:[]},
		////////////////////////////-------------list start ------------------
		...
		{type:_GROUP_, width: "98%", numCols: 1,
					items:[
					    {type:_SPACER_, height:"10"},
        				 {type:_ZACENTER_GROUPER_, numCols:1, width: "100%", label:"Selected users list",
							items:[
								{ref:ZaCRMadmin.A_sectionSalesTeamIds, type:_DWT_LIST_, height:"200", width:"98%",
		...
		{type: _GROUP_, width: "98%", numCols: 1,
					items: [
					    {type:_SPACER_, height:"10"},
						{type:_ZACENTER_GROUPER_, numCols:1, width: "100%", label:"Common users list",
							items:[
								{ref:ZaCRMadmin.A_sectionCommonSalesTeamIds, type:_DWT_LIST_, height:"200", width:"98%", cssClass: "DLSource",
