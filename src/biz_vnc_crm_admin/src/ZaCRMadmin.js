...
ZaCRMadmin.companyList = {
	items: [
		{id:ZaCRMadmin.A_companyId, type:_NUMBER_,ref:ZaCRMadmin.A_companyId},
		{id:ZaCRMadmin.A_companyName, type:_STRING_,ref:ZaCRMadmin.A_companyName},
		{id:ZaCRMadmin.A_companyAddress, type:_STRING_,ref:ZaCRMadmin.A_companyAddress},
		{id:ZaCRMadmin.A_companyPhone, type:_STRING_,ref:ZaCRMadmin.A_companyPhone},
		{id:ZaCRMadmin.A_companyFax, type:_STRING_,ref:ZaCRMadmin.A_companyFax},
		{id:ZaCRMadmin.A_companyEmail, type:_STRING_,ref:ZaCRMadmin.A_companyEmail},
		{id:ZaCRMadmin.A_companyStatus, type:_ENUM_, choices:[false,true], defaultValue:true},
		{id:ZaCRMadmin.A_companyCreatedby, type:_STRING_,ref:ZaCRMadmin.A_companyCreatedby},
		{id:ZaCRMadmin.A_companyCreateddate, type:_STRING_,ref:ZaCRMadmin.A_companyCreateddate},
		{id:ZaCRMadmin.A_companyWriteby, type:_STRING_,ref:ZaCRMadmin.A_companyWriteby},
		{id:ZaCRMadmin.A_companyWritedate, type:_STRING_,ref:ZaCRMadmin.A_companyWritedate}
	],
	type:_OBJECT_
}
...
ZaCRMadmin.stateChoices=[{value:"New",label:"New"},
...
ZaCRMadmin.sectionList = {
	items: [
	//	{ id:ZaCRMadmin.A_sectionUser, ref:ZaCRMadmin.A_sectionUser, type: _LIST_, dataType: _STRING_ },
		...
		{id:ZaCRMadmin.A_sectionManagerId, type:_STRING_,ref:ZaCRMadmin.A_sectionManagerId},
		{id:ZaCRMadmin.A_sectionLeaderId, type:_STRING_,ref:ZaCRMadmin.A_sectionLeaderId},
		{id:ZaCRMadmin.A_sectionWatcherId, type:_STRING_,ref:ZaCRMadmin.A_sectionWatcherId},
		{id:ZaCRMadmin.A_sectionSalesTeamIds, type:_STRING_,ref:ZaCRMadmin.A_sectionSalesTeamIds},
		{id:ZaCRMadmin.A_sectionCommonSalesTeamIds, type:_STRING_,ref:ZaCRMadmin.A_sectionCommonSalesTeamIds},
...
ZaCRMadmin.stageList = {
	items: [
		...
		{id:ZaCRMadmin.A_stageState, type:_STRING_,ref:ZaCRMadmin.A_stageState},
...
ZaCRMadmin.myXModel={
	items:[
		{id:ZaCRMadmin.A_company,ref:ZaCRMadmin.A_company, type:_LIST_, listItem:ZaCRMadmin.companyList}, 
		...
		{id:ZaCRMadmin.A_common_user_selection, type:_LIST_},
		{id:ZaCRMadmin.A_selected_user_selection, type:_LIST_}
	]
};
