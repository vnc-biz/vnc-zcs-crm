 ...
 */
AttachMailTabView1.prototype._resetQuery =
function(newQuery) {
 ...
 */
AttachMailTabView1.prototype._getQueryFromFolder =
function(folderId) {
 ...
 * 
 */
AttachMailTabView1.prototype.hideMe =
function() {
 ...
 * 
 */
AttachMailTabView1.prototype._createHtml1 =
function() {
	...
	//alert(AttachMailTabView1._tabAttachMailView);
...
AttachMailTabView1.prototype.searchFolder =
function(params) {
 ...
 */
AttachMailTabView1.prototype.handleSearchResponse =
function(params) {
 ...
 * @param	{hash}	params		a hash of parameters
 */
AttachMailTabView1.prototype.processDocsResponse =
function(params) {
	//alert("5");
 ...
 * @param	{hash}	params		a hash of parameters
 */
AttachMailTabView1.prototype.showResultContents =
function(params) {
	//alert("11111");
...
AttachMailTabView1.prototype.gotAttachments =
function() {
	return false;
};
 ...
 * 
 */
AttachMailTabView1.prototype.showAttachMailTreeView =
function() {
...
AttachMailTabView1.prototype._showTreeView =
function() {
...
AttachMailTabView1.prototype._setOverview =
function(params) {
...
AttachMailTabView1.prototype._treeListener =
function(ev) {
	var item = this.treeView.getSelected();
	//document.getElementById(AttachMailTabView1.ELEMENT_ID_SEARCH_FIELD).value = ["in:\"", item.getSearchPath(),"\""].join("");
	var query = this._getQueryFromFolder(item.id);
	this.executeQuery(query);
};

AttachMailTabView1.prototype._hideRoot =
function(treeView) {
...
AttachMailTabView1.prototype.executeQuery =
