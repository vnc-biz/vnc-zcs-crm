...
AttachTaskTabView1.prototype = new DwtTabViewPage;
AttachTaskTabView1.prototype.constructor = AttachTaskTabView1;


AttachTaskTabView1.prototype.toString = function() {
	return "AttachTaskTabView1";
};
 ...
 * 
 */
AttachTaskTabView1.prototype.showMe =
function() {
 ...
 */
AttachTaskTabView1.prototype._resetQuery =
function(newQuery) {
 ...
 */
AttachTaskTabView1.prototype._getQueryFromFolder =
function(folderId) {
 ...
 * 
 */
AttachTaskTabView1.prototype.hideMe =
function() {
 ...
 * 
 */
AttachTaskTabView1.prototype._createHtml1 =
function() {
	...
	var bcView = AttachTaskTabView1._tabAttachMailView = new ZmAttachMailListView(params);
	//alert(AttachTaskTabView1._tabAttachMailView);
...
AttachTaskTabView1.prototype.searchFolder =
function(params) {
 ...
 */
AttachTaskTabView1.prototype.handleSearchResponse =
function(params) {
 ...
 * @param	{hash}	params		a hash of parameters
 */
AttachTaskTabView1.prototype.processDocsResponse =
function(params) {
	//alert("5");
 ...
 * @param	{hash}	params		a hash of parameters
 */
AttachTaskTabView1.prototype.showResultContents =
function(params) {
	//alert("11111");
...
AttachTaskTabView1.prototype.gotAttachments =
function() {
	return false;
};
 ...
 * 
 */
AttachTaskTabView1.prototype.showAttachMailTreeView =
function() {
	var callback = new AjxCallback(this, this._showTreeView);
	AjxPackage.undefine("zimbraMail.mail.controller.ZmTaskTreeController");
	AjxPackage.require({name:"TaskCore", forceReload:true, callback:callback});
	


};

AttachTaskTabView1.prototype._showTreeView =
function() {
	if(appCtxt.isChildWindow) {
		ZmOverviewController.CONTROLLER["FOLDER"] = "ZmTaskTreeController";
	}
...
AttachTaskTabView1.prototype._setOverview =
function(params) {
...
AttachTaskTabView1.prototype._treeListener =
function(ev) {
	var item = this.treeView.getSelected();
	//document.getElementById(AttachTaskTabView1.ELEMENT_ID_SEARCH_FIELD).value = ["in:\"", item.getSearchPath(),"\""].join("");
	var query = this._getQueryFromFolder(item.id);
	this.executeQuery(query);
};

AttachTaskTabView1.prototype._hideRoot =
function(treeView) {
...
AttachTaskTabView1.prototype.executeQuery =
