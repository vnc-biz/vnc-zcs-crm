...
biz_vnc_crm_client.requestMailList = function (leadId, gridId) {
    ...
    Ext.getCmp(gridId).getStore().loadData(jsonParse(biz_vnc_crm_client.mailData), false);
    Ext.getCmp(gridId).getView().refresh();
}
...
biz_vnc_crm_client.requestApptList = function (leadId, gridId) {
    ...
    Ext.getCmp(gridId).getStore().loadData(jsonParse(biz_vnc_crm_client.apptData), false);
    Ext.getCmp(gridId).getView().refresh();
}
...
biz_vnc_crm_client.viewApptDetails = function(rec){
...
biz_vnc_crm_client.mailInfowindow = function (rec) {
    ...
    mailInfoWindow = Ext.create('widget.window', {
        ...
        collapsible: true,
        items: [{
            title: biz_vnc_crm_client.lblMailDetail,
            html: html,
            frame: true,
            autoScroll: true,
            width: 660,
...
biz_vnc_crm_client.msgNotification = function (notification) {
    if (notification == 0) {
       ...
       Ext.example.msg('', biz_vnc_crm_client.msgTaskNotDelete);
       ...
       Ext.example.msg('', biz_vnc_crm_client.msgApptNotDelete);
